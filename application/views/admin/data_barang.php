<div class="container-fluid">
    <!-- btn tambah barang menggunakan bootstrap modal -->
    ...
    <table class="table table-bordered">
        ...
        <!-- melakukan perulang untuk menagambil data dari datbase -->
        <?php
        $no = 1;
        foreach ($barang as $brg) : ?>
            <tr>
                ...
                <td><?php echo anchor('admin/data_barang/detail/' . $brg->id_brg, '<div class="btn btn-primary btn-sm"><i class="fas fa-search-plus"></i></div>') ?>
                <td><?php echo anchor('admin/data_barang/edit/' . $brg->id_brg, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>') ?>

                </td>
                <td>
                    <?php echo anchor('admin/data_barang/hapus/' . $brg->id_brg, '<div class="btn btn-danger btn-sm" onclick="yakin?"><i class="fas fa-trash"></i></div>') ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambah_barangLabel">Form Tambah Barang</h5>
